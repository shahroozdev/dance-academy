...
function DialogContent({
  ...
  return (
    <DialogPortal>
      ...
      >
        {header && (
          <div data-slot="dialog-header-fixed" className="shrink-0 border-b p-4 text-lg font-medium">
            {header}
          </div>
        )}
        <div data-slot="dialog-scroll-area" className="grid min-h-0 flex-1 gap-4 overflow-y-auto p-4">
          {children}
        </div>
        {showCloseButton && (
