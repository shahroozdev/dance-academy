...
export default function StudentsPage() {
  ...
  const { data, isLoading } = useQuery("getStudents", [{ search: search || undefined, page, pageSize }]);
      ...
      <PageHeader
        ...
        actions={
          <div className="flex flex-wrap gap-2">
            <TooltipWrapper label="Import students from CSV">
              <Button variant="outline" onClick={() => setIsImportOpen(true)}>
                <Upload className="size-4" />
                Import CSV
              </Button>
            </TooltipWrapper>
            <TooltipWrapper label="Export all students as CSV">
